import {
  FieldClientComponent, //custom field client component type
  StaticDescription,
  StaticLabel,
  TextField, //form field components; it is a custom upload component, view under upload feature in payload
  TextFieldClient, // custom field client type
  TextFieldValidation,
} from 'payload'
